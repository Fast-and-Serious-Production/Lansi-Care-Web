...
export default function homepage(){
  ...
  <div className="w-96 h-96 relative">
    ...
    <div className="w-96 h-80 left-[34.64px] top-[136.07px] absolute bg-zinc-300 rounded-3xl">
      <div className="origin-top-left rotate-180 w-5 h-5 left-[39.12px] top-[163.50px] absolute">
      </div>
      <div className="w-5 h-5 left-[1248.08px] top-[151.25px] absolute">
      </div>
      <div className="w-5 h-5 left-[1324.39px] top-[143.50px] absolute">
      </div>
    </div>
  </div>
