  ...
  return (
    <>
      <section>
        ...
        <div className="relative mb-20 mt-[400px] grid h-10 w-full grid-cols-4">
        ...
        {/* deskripsi */}
        <div className="relative mx-40 my-40 h-full">
          <div className="ml-20 mt-10">
            ...
            <div className="font-medium">
              <p className="ml-80 mr-20 flex justify-normal text-left">
                ...
                InnoSync yang terdiri dari empat individu berbakat yang terdiri
                dari Rakha, sebagai ketua kami, memimpin dengan visi yang kuat
                serta mengarahkan tim untuk terus berkembang. Ada pula hacker
                kami yaitu Naufal, developer yang membawa keahlian teknis yang
                mendalam serta bertanggung jawab atas program yang ada. Serta
                ada Raisya, hustler kami, memiki keterampilan komunikasi dan
                negosiasi yang luar biasa, dan ada pula Keefa, hipster kreatif,
                menambahkan sentuhan estetika yang unik, sehingga membawa kesan
                megah kepada tim kami.
              </p>
              <br />
              <p className="ml-80 mr-20 flex justify-normal text-left">
                ...
                bisa memberikan alternatif atas permasalahan yang ada, sehingga
                website kami memiliki manfaat bagi lingkungan sekitar.
              </p>
              <br />
              <p className="ml-80 mr-20 flex justify-normal text-left">
