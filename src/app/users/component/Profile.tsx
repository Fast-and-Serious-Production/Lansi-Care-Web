        ...
        <div className="w-[1438px] h-[1149px] px-[35px] py-[17px] bg-zinc-100 flex-col justify-start items-start gap-2.5 inline-flex">
          <div className="w-[1417.48px] h-[1085.03px] relative">
            ...
            <div className="w-[1346.55px] h-[125.20px] left-[47.48px] top-[515.41px] absolute">
              <span className="text-black text-[32px] font-semibold font-['Roboto'] leading-10 tracking-wider">
                Muhammad Keefa Syawal
                <br />
              </span>
              <span className="text-black text-xl font-medium font-['Roboto'] leading-10 tracking-wide">
                NFC ID:
                <br />
                NIK:{" "}
              </span>
