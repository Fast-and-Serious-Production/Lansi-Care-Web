...
<footer className="bg-base-150 dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-20">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                  <Image src={LogoFooter} width={200} alt="FlowBite Logo"/>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div className='mr-10'>
                  <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Resource</h2>
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  <li className="mb-4">
